/*
 The program must accept three integers X, Y and K as the input. The program must print the count of
integers from X to Y which contains the integer K as a subset.
...
Output Format:
The first line contains the count of integers from X to Y which contains the integer K as a subset.
 ...
 */
public class CountOfInteger_SubsetOfK {
