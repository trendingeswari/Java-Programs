/*
 The program must accept a string S containing only alphabets as the input. The program must remove
the repeated alphabets in the string S and print the modified string as the output.
...
fFght
 */
public class RemoveRepeatedAlphabets {
